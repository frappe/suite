...
**Storage Reservation**:
Drive storage held temporarily for expected file content and counted against
an owner's quota until replaced by stored file usage or released.
...
storage against the owner's quota. Use each term in its own domain.

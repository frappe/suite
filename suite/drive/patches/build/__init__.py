...
history they carry, so it needs the template nodes step 8 creates. A deck
adopted at step 10 has no media in the same pass: step 8 defers it and the
next pass converts it.

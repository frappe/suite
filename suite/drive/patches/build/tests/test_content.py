...
class ContentTest(unittest.TestCase):
    ...
    def test_write_and_submit_shares_both_reach_a_direct_edit_grant(self):
        ...
        shares = [
            ...
            ContentShareRow("share-2", second.doctype, second.name, user="reader@example.com", submit=1),
        ]
        source = FakeContent(
        ...
        self.assertEqual(target.grant_roles("file-2", ("reader@example.com",))["reader@example.com"], EDIT)

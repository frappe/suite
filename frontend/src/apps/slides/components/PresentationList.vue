<template>
  <div class="flex size-full flex-col overflow-hidden py-8">
    ...
    >
      <!-- Header -->
      <div class="cursor-default text-2xl-semibold text-ink-gray-9">
        Presentations
      </div>
    ...
    <div class="faded-scroll flex min-h-0 flex-1 flex-col overflow-y-auto py-4">
          ...
          <div class="flex flex-col gap-3">
            ...
            >
              <div
                ...
                class="size-full"
                :style="
                  getThumbnailCardStyles(presentation.thumbnail, presentation)
                "
              ></div>
              <div
                v-else
            ...
            <div class="flex items-start justify-between">
              ...
              >
                <template #default>
                  <LucideEllipsis
                    class="size-3.5 cursor-pointer text-ink-gray-5"
                  />
                </template>
              </Dropdown>
            </div>
      ...
      <div v-else class="m-auto flex flex-col items-center gap-6">
        ...
        <div class="flex flex-col items-center gap-2">
          <div class="text-xl-medium text-ink-gray-7">
            No presentations yet.
          </div>
          <div class="text-base text-ink-gray-5">
            Add a new presentation to get started!
          </div>
        </div>
        <Button
          variant="subtle"
...
const filteredPresentations = computed(() => {
  ...
  return sortedPresentations.value.filter((p) =>

...
import { activeEntity, renamingEntity } from '@/apps/drive/legacy/data/selection'
import InlineRenameInput from './InlineRenameInput.vue'
import { openEntity, isModKey, isVirtual, folderRoute, getThumbnailUrl, displayFileName } from '@/apps/drive/legacy/utils/files'
import { formatDate } from '@/apps/drive/legacy/utils/format'
import { expandedFolders } from '@/apps/drive/legacy/data/folderTree'

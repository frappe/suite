<template>
  ...
  <div
    v-else
    class="max-w-[450px] h-fit self-center p-10 bg-surface-base rounded-4 text-3xl-medium text-center shadow-xl flex flex-col justify-center items-center gap-4"
  >

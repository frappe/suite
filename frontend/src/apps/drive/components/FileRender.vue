<template>
  <div
    v-if="error"
    class="max-w-[450px] h-fit self-center p-10 border border-outline-gray-2 bg-surface-base rounded-4 text-3xl-medium text-center shadow-xl flex flex-col justify-center items-center gap-4"
  >

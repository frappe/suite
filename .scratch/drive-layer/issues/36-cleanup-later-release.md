...
**Blocked by:** [31 — Rehearse Build on an approved export and verify rollback](31-migration-rehearsal.md); [34 — Adopt document media, grouped composites, and collab credentials](34-frontend-content-adoption.md); [35 — Implement Cleanup with refusal gates and fixture tests](35-cleanup-implementation.md)

**Status:** blocked

**Owner:** Suite release operations

**Execution gate:** Requires the later release, completed frontend adoption, verified runtime gates, and authorization for destructive deployment.

**Source:** [Drive spec](../../../wayfinder/drive-layer-spec/drive-layer-spec.md), §14.10–14.11; later-release gate.

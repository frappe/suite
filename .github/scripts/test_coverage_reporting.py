...
class CoverageReportTest(unittest.TestCase):
    ...
    def test_uses_baseline_when_suite_was_skipped(self):
        baseline = coverage_report.Coverage(80, 100, 60, 100)

        self.assertIs(coverage_report.effective_coverage(None, baseline, "skipped"), baseline)

    def test_does_not_mask_missing_coverage_after_test_attempt(self):
        baseline = coverage_report.Coverage(80, 100, 60, 100)

        self.assertIsNone(coverage_report.effective_coverage(None, baseline, "failure"))

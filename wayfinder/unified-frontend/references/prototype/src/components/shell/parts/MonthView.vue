<!--
  Month grid in the same ink-first language as the week: a colour badge
  carries the calendar, the title is ink, nothing is filled.
    ...
    <div class="grid min-h-0 flex-1 auto-rows-fr">
      ...
      >
        ...
        >
          ...
          <Popover v-for="event in day.shown" :key="event.id">
            <template #target>
              <button

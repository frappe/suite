<!--
  Bare 7-column month grid: weekday letters plus one cell per day. It renders
  no styling of its own — the caller styles each day through the `day` slot,
  so the sidebar mini-month and the Year view share the date maths without
  sharing a look.

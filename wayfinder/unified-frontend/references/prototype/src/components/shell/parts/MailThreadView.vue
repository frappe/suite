<!--
  The reading pane: one thread, its messages, and the actions that would act
  on it.
      ...
      <div class="mx-auto flex max-w-3xl flex-col gap-4">
        ...
        <div class="flex items-start gap-3">
          ...
          <Tooltip placement="bottom">
            ...
            >
              <StarMark v-if="starred" class="size-4" />
              <span v-else class="lucide-star size-4 text-ink-gray-5" aria-hidden="true" />
            </Button>
            ...
            <div class="flex min-w-0 flex-1 flex-col pb-4">
              ...
              >
                ...
                <span
                  ...
                  aria-hidden="true"
                />
                <span class="ml-auto shrink-0 text-xs text-ink-gray-5">
              ...
              <article v-else>
                <header class="flex h-7 items-center gap-1.5">
                  ...
                  <div class="ml-auto flex shrink-0 items-center gap-0.5">
                    <span class="pr-1 text-xs text-ink-gray-5">

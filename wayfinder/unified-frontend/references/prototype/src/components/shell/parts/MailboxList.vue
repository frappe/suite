<!--
  Mail nav shared by every variant's mail chrome. It draws one section —
  system mailboxes by default, or the user's own folders when they are passed
  in — so both read identically in the panel.
-->
<template>

// Date maths shared by the week, month and year grids. Weeks start on Sunday
// everywhere in this prototype.
import dayjs, { type Dayjs } from 'dayjs'

export const ISO = 'YYYY-MM-DD'

/**
 * The demo clock, 'HH:mm'. Pinned so a screenshot is reproducible: the now
 * line sits in the same place every time. Set to null to follow the real
 * clock.
 */

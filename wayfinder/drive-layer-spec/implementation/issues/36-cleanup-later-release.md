...
**Blocked by:** [31 — Rehearse Build on an approved export and verify rollback](31-migration-rehearsal.md); [35 — Implement Cleanup with refusal gates and fixture tests](35-cleanup-implementation.md); the [unified suite frontend effort](../../../unified-frontend/MAP.md) has migrated every Drive client off the legacy methods
